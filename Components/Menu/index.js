...
import { Text, View, Button, List, Content, Card, CardItem } from "native-base";
...
class MenuPage extends Component {
  ...
  onPressButton(category){
    this.props.filterItems(category)
    this.setState({buttonClicked:category})
  }
          ...
          <View>
            <View style={{alignContent:"flex-start",flexDirection:"row", flexWrap:"wrap", justifyContent:"center", marginTop:20}}>
              ...
              <View style={{marginHorizontal:2, marginVertical:2}}>
                <Button onPress={() => this.onPressButton("All")}>
